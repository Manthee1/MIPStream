...
export default class MIPSBase {
    ...
    public cpuLayout: CPULayout = {
        ...
        components: [
            ...
            { id: "PC", label: "PC", type: "register", dimensions: { width: 50, height: 50 }, pos: { x: 44, y: 345 }, ports: oneToOnePorts(_.NPC_MEM, _.PC) },
            { id: "InstructionMemory", label: "InstructionMemory", type: "register", dimensions: { width: 100, height: 150 }, pos: { x: 148, y: 340 }, ports: instructionMemoryPorts },
            { id: "Const4", label: "Const4", type: "register", dimensions: { width: 30, height: 30 }, pos: { x: 129, y: 200 }, ports: singleOutput(4) },
            { id: "NextPCAdder", label: "NextPCAdder", type: "register", dimensions: { width: 50, height: 50 }, pos: { x: 193, y: 175 }, ports: twoToOnePorts(_.PC, 4, _.NPC_IF) },
            ...
            { id: "ImmExtend", label: "ImmExtend", type: "register", dimensions: { width: 50, height: 50 }, pos: { x: 501, y: 525 }, ports: oneToOnePorts(_.Imm_ID, _.SignedImm_ID) },
            { id: "ShiftLeft", label: "ShiftLeft", type: "register", dimensions: { width: 50, height: 50 }, pos: { x: 701, y: 253 }, ports: oneToOnePorts(_.SignedImm_EX, _.ShiftedImm_EX) },
            { id: "BranchAdder", label: "BranchAdder", type: "register", dimensions: { width: 50, height: 50 }, pos: { x: 787, y: 226 }, ports: twoToOnePorts(_.NPC_EX, _.ShiftedImm_EX, _.TargetPC_EX) },
            { id: "ALUSrcMUX", label: "ALUSrcMUX", type: "mux", dimensions: { width: 25, height: 50 }, pos: { x: 713, y: 386 }, ports: muxesPorts.ALUSrcMUX },
            { id: "ALU", label: "ALU", type: "register", dimensions: { width: 50, height: 100 }, pos: { x: 776, y: 330 }, ports: aluPorts },
            ...
            { id: "BranchAndGate", label: "BranchAndGate", type: "register", dimensions: { width: 25, height: 25 }, pos: { x: 967, y: 304 }, ports: twoToOnePorts(_.Branch_MEM, _.Zero_MEM, _.BranchCond_MEM) },
            { id: "BranchMUX", label: "BranchMUX", type: "mux", dimensions: { width: 25, height: 50 }, pos: { x: 960, y: 210 }, ports: muxesPorts.BranchMUX },
            { id: "DataMemory", label: "DataMemory", type: "register", dimensions: { width: 100, height: 150 }, pos: { x: 951, y: 365 }, ports: dataMemoryPorts },
