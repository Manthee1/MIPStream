...
const cpuLayout: CPULayout = {
    ...
    height: 800,
    components: [
        { id: "IFtoID", dimensions: { width: 50, height: 300 }, pos: { x: 370, y: 279 }, ports: [] },
        { id: "IDtoEX", dimensions: { width: 50, height: 300 }, pos: { x: 454, y: 267 }, ports: [] },
        { id: "EXtoMEM", dimensions: { width: 50, height: 300 }, pos: { x: 566, y: 336 }, ports: [] },
        { id: "MEMtoWB", dimensions: { width: 50, height: 300 }, pos: { x: 646, y: 335 }, ports: [] },
        { id: "PC", dimensions: { width: 50, height: 50 }, pos: { x: 70, y: 50 }, ports: [] },
        { id: "InstructionMemory", dimensions: { width: 100, height: 150 }, pos: { x: 177, y: 55 }, ports: [] },
        { id: "Const4", dimensions: { width: 50, height: 50 }, pos: { x: 250, y: 50 }, ports: [] },
        { id: "NextPCAdder", dimensions: { width: 50, height: 50 }, pos: { x: 350, y: 50 }, ports: [] },
        { id: "ControlUnit", dimensions: { width: 50, height: 100 }, pos: { x: 450, y: 50 }, ports: [] },
        { id: "RegisterControlUnit", dimensions: { width: 120, height: 200 }, pos: { x: 550, y: 50 }, ports: [] },
        { id: "ImmExtend", dimensions: { width: 50, height: 50 }, pos: { x: 650, y: 50 }, ports: [] },
        { id: "ShiftLeft", dimensions: { width: 50, height: 50 }, pos: { x: 750, y: 50 }, ports: [] },
        { id: "BranchAdder", dimensions: { width: 25, height: 25 }, pos: { x: 269, y: 266 }, ports: [] },
        { id: "ALUSrcMUX", dimensions: { width: 25, height: 50 }, pos: { x: 125, y: 241 }, ports: [] },
        { id: "ALU", dimensions: { width: 50, height: 100 }, pos: { x: 250, y: 150 }, ports: [] },
        { id: "ALUControl", dimensions: { width: 50, height: 50 }, pos: { x: 350, y: 150 }, ports: [] },
        { id: "RegDstMUX", dimensions: { width: 25, height: 50 }, pos: { x: 450, y: 150 }, ports: [] },
        { id: "BranchAndGate", dimensions: { width: 50, height: 50 }, pos: { x: 550, y: 150 }, ports: [] },
        { id: "BranchMUX", dimensions: { width: 25, height: 50 }, pos: { x: 650, y: 150 }, ports: [] },
        { id: "DataMemory", dimensions: { width: 100, height: 150 }, pos: { x: 750, y: 150 }, ports: [] },
        { id: "MemtoRegMUX", dimensions: { width: 25, height: 50 }, pos: { x: 384, y: 369 }, ports: [] },
    ],
};
