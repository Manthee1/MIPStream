...
const cpuLayout: CPULayout = {
	...
	components: [
		...
		{ id: "NextPCAdder", dimensions: { width: 50, height: 50 }, pos: { x: 290, y: 50 }, ports: [] },
		{ id: "ControlUnit", dimensions: { width: 50, height: 100 }, pos: { x: 410, y: 90 }, ports: [] },
		{ id: "RegisterControlUnit", dimensions: { width: 120, height: 200 }, pos: { x: 400, y: 220 }, ports: [] },
		{ id: "ImmExtend", dimensions: { width: 50, height: 50 }, pos: { x: 440, y: 450 }, ports: [] },
		{ id: "ShiftLeft", dimensions: { width: 50, height: 50 }, pos: { x: 700, y: 110 }, ports: [] },
		{ id: "BranchAdder", dimensions: { width: 25, height: 25 }, pos: { x: 770, y: 80 }, ports: [] },
		{ id: "ALUSrcMUX", dimensions: { width: 25, height: 50 }, pos: { x: 720, y: 280 }, ports: [] },
		{ id: "ALU", dimensions: { width: 50, height: 100 }, pos: { x: 780, y: 220 }, ports: [] },
		{ id: "ALUControl", dimensions: { width: 50, height: 50 }, pos: { x: 780, y: 360 }, ports: [] },
		{ id: "RegDstMUX", dimensions: { width: 25, height: 50 }, pos: { x: 700, y: 470 }, ports: [] },
		{ id: "BranchAndGate", dimensions: { width: 50, height: 50 }, pos: { x: 960, y: 80 }, ports: [] },
		{ id: "BranchMUX", dimensions: { width: 25, height: 50 }, pos: { x: 1040, y: 40 }, ports: [] },
		{ id: "DataMemory", dimensions: { width: 100, height: 150 }, pos: { x: 960, y: 190 }, ports: [] },
		{ id: "MemtoRegMUX", dimensions: { width: 25, height: 50 }, pos: { x: 1160, y: 330 }, ports: [] },
	],
	connections: [
	],
